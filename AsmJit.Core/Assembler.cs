namespace AsmJitNet
{
        ...
        , IXmmIntrinsicSupport<XMMReg>
    {
        ...
        public static InstructionCode ConditionToJump(Condition condition)
        {
        ...
        public static InstructionCode ConditionToMovCC(Condition condition)
        {
            Contract.Requires(condition >= 0 && condition <= (Condition)0xF);
        ...
        public static InstructionCode ConditionToSetCC(Condition condition)
        {
            Contract.Requires(condition >= 0 && condition <= (Condition)0xF);
  ...
  assertIllegal = true;
    ...
    if (assertIllegal)
    {
      ...
      assertionFailure(__FILE__, __LINE__, bufStorage);
        ...
        public static void DumpOperand(StringBuilder buf, Operand op)
        {
            if (op.IsReg)
            {
